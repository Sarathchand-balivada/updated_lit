...
@Entity
@Table(name="AssetRegisterdetials")
public class AssetRegisterEntity {
	...
	public AssetRegisterEntity() {
		
	}

	public AssetRegisterEntity(long id, String normalChairs, String wheelChairs, String acRemotes, String fanRemotes,
