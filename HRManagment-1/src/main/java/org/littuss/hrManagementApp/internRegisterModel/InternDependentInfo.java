...
@Entity
public class InternDependentInfo {
	 @Id
	...
	//Dependent Info
     ...
     //NoArgConstructor
	 public InternDependentInfo() {	}

	 //ConStructorWithFields
	public InternDependentInfo(String dependentName1, String dependentRelationship1, String dependentDateOfBirth1,
