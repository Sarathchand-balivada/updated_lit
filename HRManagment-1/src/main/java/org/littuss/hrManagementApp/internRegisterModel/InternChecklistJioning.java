...
@Entity
public class InternChecklistJioning {
	 @Id
  ...
  //NoArgConstructor
	public InternChecklistJioning() {	}

	//ConstructorWithArgument
     public InternChecklistJioning(String signCopyOfAppointLetter, String passportphotos3, String latestCV, String proofOfIdentity,
