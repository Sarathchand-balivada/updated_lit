...
@Entity
public class InternEmergencyContact {
	 @Id
	...
	//Emergency Contact info1
     ...
     //NoArgConstructor
	 public InternEmergencyContact() {	}

	 //ConstructorWithFields
	public InternEmergencyContact(String emgName1, String emgRelationship1, String emgLandlineNoWithStd1, String emgMobileNo1,
