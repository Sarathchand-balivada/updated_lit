...
@Entity
public class InternAcknowledgement {
	 @Id
	...
	//Acknowledgement
     ...
     //NoArgConstructor
	public InternAcknowledgement() {	}
	
	//ConstructorWithFields
	public InternAcknowledgement(String acknowledgementAgreeName, String signdate, String empSign) {
